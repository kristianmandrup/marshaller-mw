...
(function(){
  var rek, requires, assert, expect, _, Person, DecoratorMw, MarshalMw, ContextDecorators, middleware, Middleware, loadMwStack, app, person, decoratedPerson, storeMwStack, modelMw, ModelMw, ModelRunner;
  rek = require('rekuire');
    ...
    describe('create instance', function(){
      context('no args', function(){
        return specify('is created', function(){
          return expect(new MarshalMw.constructor).to.eql(MarshalMw);
        });
      });
