...
(function(){
  var rek, requires, assert, expect, _, Person, DecoratorMw, MarshallerMw, ContextDecorators, middleware, Middleware, loadMwStack, app, person, decoratedPerson, storeMwStack, modelMw, ModelMw, ModelRunner;
  rek = require('rekuire');
